...
func TestAuth(t *testing.T) {
	...
	// test like post, expected like value is 1
	t.Run("likePost0to1", func(t *testing.T) {
		req, err := http.NewRequest(http.MethodPost, testServer.URL+"/api/posts/1/like",
			nil)
		if err != nil {
			t.Fatal(err)
		}
	...
	// test like post again, expected like value is 0
	t.Run("likePost1to0", func(t *testing.T) {
		req, err := http.NewRequest(http.MethodPost, testServer.URL+"/api/posts/1/like",
			nil)
		if err != nil {
			t.Fatal(err)
	...
	// add dislike to post, expected dislike value is -1
	t.Run("dislikePost0to-1", func(t *testing.T) {
		req, err := http.NewRequest(http.MethodPost, testServer.URL+"/api/posts/1/dislike",
			nil)
		if err != nil {
			t.Fatal(err)
		}
	...
	// add dislike to post again, expected dislike value is 0
	t.Run("dislikePost-1to0", func(t *testing.T) {
		req, err := http.NewRequest(http.MethodPost, testServer.URL+"/api/posts/1/dislike",
			nil)
		if err != nil {
			t.Fatal(err)
