...
class Login {
  ...
  private async onSubmit(event: Event) {
    ...
    // const rememberMeInput = this.form.querySelector("#logCheck") as HTMLInputElement
...
class Signup {
  ...
  private getFormData(): SignupForm {
    ...
    const ageInput = this.form.querySelector("#age") as HTMLInputElement
    const genderInput = this.form.querySelector("#gender") as HTMLInputElement
    const passwordInput = this.form.querySelector(
      "#password-register"
    ) as HTMLInputElement
...
export const loginController = async () => {
  ...
  const pwShowHide = document.querySelectorAll(
    ".showHidePw"
